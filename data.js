window.versesData = {
  attributions: {
    NIV: 'Scripture quotations taken from The Holy Bible, New International Version®, NIV®. Copyright © 1973, 1978, 1984, 2011 by Biblica, Inc.™ Used by permission.',
  ...
  modules: [
    ...
    },
    {
      ...
      verses: [
        ...
        { ref: "2 Corinthians 4:17-18", text: {
          NIV: "For our light and momentary troubles are achieving for us an eternal glory that far outweighs them all. So we fix our eyes not on what is seen, but on what is unseen, since what is seen is temporary, but what is unseen is eternal.",
          ESV: "For this light momentary affliction is preparing for us an eternal weight of glory beyond all comparison, as we look not to the things that are seen but to the things that are unseen. For the things that are seen are transient, but the things that are unseen are eternal."
        }}
      ]
    },
    {
    ...
    {
      id: 4,
      name: "Standing With a Friend",
      color: "#a3a01f",
      verses: [
        { ref: "Hebrews 10:24-25", text: {
    ...
    {
      id: 9,
      name: "How to Teach and Pray",
      color: "#4a3fa8",
      verses: [
        { ref: "1 Samuel 12:23", text: {
    ...
    },
    {
      ...
      verses: [
        { ref: "Romans 5:8", text: {
          ...
          ESV: "But God shows his own love for us in that while we were still sinners Christ died for us."
        }},
        { ref: "Romans 10:9", text: {
          ...
          ESV: "But if you confess with your mouth that Jesus is Lord and believe in your heart that God raised him from the dead, you will be saved."
        }},
        { ref: "1 John 5:11-13", text: {
          NIV: "And this is the testimony: God has given us eternal life, and this life is in his Son. Whoever has the Son has life; whoever does not have the Son of God does not have life. I write these things to you who believe in the name of the Son of God so that you may know that you have eternal life.",
          ESV: "And this is the testimony, that God gave us eternal life and this life is in his Son. Whoever has the Son has life; whoever does not have the Son of God does not have life. I write these things to you who believe in the name of the Son of God, that you may know that you have eternal life."
        }},
        { ref: "2 Timothy 3:16-17", text: {
          ...
          ESV: "All scripture is breathed out by God and profitable for teaching, for reproof, for correction and for training in righteousness that the man of God may be complete, equippped for every good work."
        }}
      ]
    },
    {
    ...
    {
      id: 12,
      name: "Engaging Your Culture",
      color: "#c1334e",
      verses: [
        { ref: "Matthew 9:36-38", text: {
          NIV: "When he saw the crowds, he had compassion on them, because they were harassed and helpless, like sheep without a shepherd. Then he said to his disciples, “The harvest is plentiful but the workers are few. Ask the Lord of the harvest, therefore, to send out workers into his harvest field.”",
        ...
        { ref: "Matthew 22:37-39", text: {
          ...
          ESV: "And he said to him, “You shall love the Lord your God with all your heart and with all your soul and with all your mind. This is the great and first commandment. And a second is like it: You shall love your neighbor as yourself."
        }}
      ]
    }
  ]
